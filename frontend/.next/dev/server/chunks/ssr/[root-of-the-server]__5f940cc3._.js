    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            if (Array.isArray(signed)) {
                if (signed.length && typeof signed[0] === 'string') signedBlobs = signed.map((s)=>base64ToUint8Array(String(s)));
                else if (signed.length && signed[0] && signed[0].blob) signedBlobs = signed.map((s)=>base64ToUint8Array(s.blob));
            } else if (signed && signed.signedTransactions) {
                signedBlobs = signed.signedTransactions.map((s)=>base64ToUint8Array(s));
            }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5f940cc3._.js.map