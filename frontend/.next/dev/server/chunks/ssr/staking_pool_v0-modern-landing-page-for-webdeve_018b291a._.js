...
function StakingForm() {
    ...
    const handleStake = async ()=>{
        ...
        // At this point the wallet is connected. Perform staking flow (placeholder).
        if (!amount || parseFloat(amount) < 1) {
            alert('Enter a valid amount (>= 1 ALGO)');
            return;
        }
        alert(`Staking ${amount} ALGO for ${lockPeriod} days (APR ${apy[lockPeriod]}%).\n\nThis is a demo placeholder — implement on-chain transaction to stake.`);
    };
...
//# sourceMappingURL=staking_pool_v0-modern-landing-page-for-webdeve_018b291a._.js.map